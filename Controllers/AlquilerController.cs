...
namespace alquilautos.Controllers
{
    public class AlquilerController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,Genre,Price")] Alquiler alquiler)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseDate,Genre,Price")] Alquiler alquiler)
        {
            if (id != alquiler.Id)
            {
                return NotFound();
